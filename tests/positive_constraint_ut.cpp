...
TEST_CASE("positive constraint with checked arithmetic - invalid construction")
{
...
TEST_CASE("positive constraint with checked arithmetic - constraint violation")
{
...
TEST_CASE("positive constraint with saturating - underflow to zero throws")
{
    ...
    // Saturating subtraction: 5 - 10 saturates to 0, which violates positive
    // constraint
...
TEST_CASE("positive constraint with saturating - overflow stays positive")
{
    ...
    // Saturating addition: 200 + 100 saturates to 255, which is still positive
    CHECK_NOTHROW(a + b);
